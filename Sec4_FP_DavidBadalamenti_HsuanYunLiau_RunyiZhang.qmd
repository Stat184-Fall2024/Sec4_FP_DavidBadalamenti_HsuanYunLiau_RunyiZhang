...
Directly comparing the age to the milage is hard as they have different subgroups but the comparing the affect of the age or mileage to the different types of cars was much easier. If we were to do further investigations we might try and find what makes some of those cars outliers like what attributes does leads to an extreme price or if it was maybe the seller changing the price of the car beyond what it would actually sell for.
